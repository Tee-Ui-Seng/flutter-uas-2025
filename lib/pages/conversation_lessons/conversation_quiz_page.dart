  ...
  final List<Map<String, dynamic>> _questions = [
    {
      ...
      'options': ['Xub asti?', 'Salâm!', 'Tašakur', 'Bebaxšîn'],
      'correctAnswer': 1,
      'explanation': '"Hello" in Persian is "Salâm!" (سلام).',
    },
    {
      'question': 'What is the appropriate response to "Salâm!"?',
      'options': ['Tašakur', 'Xub astam', 'Salâm!', 'Bebaxšîn'],
      'correctAnswer': 2,
      'explanation': 'The typical response to "Salâm!" is also "Salâm!"',
    },
    {
      'question': 'How do you ask "What is your name?" formally?',
      'options': ['Ciṭûrî?', 'Ism man ... ast', 'Ism-e šumâ ci ast?', 'Az kojâ hasted?'],
      'correctAnswer': 2,
      'explanation': '"What is your name?" is "Ism-e šumâ ci ast?" (اسم شما چه است؟)',
    },
    {
      'question': 'What does "az dîdan-e tân xošhâl astam" mean?',
    ...
    },
    {
      ...
      'options': ['Bebaxšîn', 'Lotfan', 'Tašakur', 'Xub'],
      'correctAnswer': 2,
      'explanation': '"Thank you" is "Tašakur" (تشکر)',
    },
    {
      'question': 'What is the appropriate response to "Tašakur"?',
    ...
    },
    {
      ...
      'options': ['Šab baxair!', 'Subh baxair!', 'Ba\'d az zohr baxair!', 'Rûz-e xubî!'],
      'correctAnswer': 1,
      'explanation': '"Good morning" is "Subh baxair!" (صبح بخیر)',
    },
    {
      'question': 'What does "bebaxšîn" mean?',
      'options': ['Please', 'Thank you', 'Excuse me/Sorry', 'Goodbye'],
      'correctAnswer': 2,
      'explanation': '"Bebaxšîn" (ببخشین) means both "Excuse me" and "Sorry"',
    },
    {
      'question': 'How do you say "Goodbye" in Persian?',
      'options': ['Xodâ hâfez', 'Salâm', 'Xub asti', 'Lotfan'],
      'correctAnswer': 0,
      'explanation': '"Goodbye" is "Xodâ hâfez" (خدا حافظ)',
    },
    {
      'question': 'What is the meaning of "lotfan"?',
      'options': ['Thank you', 'Please', 'Sorry', 'Yes'],
      'correctAnswer': 1,
      'explanation': '"Lotfan" (لطفاً) means "Please"',
    },
  ];
